...
docker rm %container%
docker run -it  --name %container%  -v %basedir%:/dita ghcr.io/dita-ot/dita-ot:3.6.1  -i /dita/src/sldocs.ditamap  -o /dita/%outdir%  -f markdown  --propertyfile /dita/src/sldocs-in-app.properties  -v
...
xcopy %basedir%\%outdir% %githubiodir%\md /s /v /y
